			...
			<div class="row">
				<div class="col-lg-12 ">
					<div class="alert alert-info">
						...
						<font color="black">
							<ol>
								<li><b>Enkripsi</b> : Digunakan untuk mengenkrip data</li>
									<ul>
										<li>Pilih Menu <font color="black"><b>Enkripsi</b></font> pada Form Menu</li>
								...
								<li><b>Dekripsi</b> : Digunakan untuk membuka enkrip data</li>
									<ul>
										<li>Pilih Menu <font color="black"><b>Dekripsi</b></font> pada Form Menu</li>
